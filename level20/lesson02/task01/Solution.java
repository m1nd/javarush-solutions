...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("D:\\Share\\JavaSource\\JavaRushHomeWork\\JavaRushHomeWork\\src\\com\\javarush\\test\\level19\\lesson05\\task02\\2.txt", null);
            ...
            String result = ivanov.equals(somePerson) ? "yes" : "no";
    ...
    public static class Human {
        ...
        public boolean equals(Human obj) {
            if (this.name.equals(obj.name)){
                ...
                {
                    if (this.assets.get(i).getName().equals(obj.assets.get(i).getName()) &&  this.assets.get(i).getPrice() == obj.assets.get(i).getPrice()){
                        continue;
                    } else return false;
                }
